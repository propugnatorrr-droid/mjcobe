  ...
  return (
    <form action={action} className="flex max-w-2xl flex-col gap-10">
      ...
      <div className="flex items-center gap-6">
        <button
          type="submit"
          className="rounded-[2px] bg-[var(--surface-invert)] px-6 py-3 font-ui text-sm uppercase tracking-[0.08em] text-[var(--surface-bg)] transition-colors [transition-duration:var(--duration-signature)] hover:bg-[var(--surface-invert-hover)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--champagne)]"
        >
