...
import { supporterAccessForCampaign } from '@/lib/supporter/access';
...
export default async function SongPage({
  ...
  return (
    ...
    >
      ...
      <div className="site-shell song-content song-conversion">
      ...
      <div className="site-shell song-content song-story">
        <UpdateList
